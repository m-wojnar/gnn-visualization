...
if __name__ == '__main__':
    ...
    X, y, distances, indexes, nn_val = FaissGenerator.load('../data/mnist/small_mnist_784_nn100_euclidean.pkl.lz4')
    ...
    for i in range(20, 101, 20):
        ...
        model.load_state_dict(torch.load(f'checkpoints/vis_gnn_model_{i}.pt'))
